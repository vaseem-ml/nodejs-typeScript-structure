...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/',
            ...
            function adminController_adminHome(request: any, response: any, next: any) {
            const args = {
            ...
            const promise = controller.adminHome.apply(controller, validatedArgs as any);
        ...
        app.post('/api/otp',
            ...
            const promise = controller.createOtp.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/users',
